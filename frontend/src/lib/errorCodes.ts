// MIRROR of backend/src/lib/errorCodes.ts. CI should grep-assert the two
// arrays remain in sync; out-of-band drift means error translations will fall
// through to the server-side fallback string for the unrecognized codes.
